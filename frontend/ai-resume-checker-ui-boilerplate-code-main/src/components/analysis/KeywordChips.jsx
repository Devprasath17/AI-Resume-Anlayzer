...
function Chip({ children, tone }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 h-7 pl-1.5 pr-3 rounded-full bg-[#FEE2E2]/70 text-[var(--danger)] text-[12px] font-semibold transition-transform hover:-translate-y-px">
  ...
  return (
    <div className="flex items-center gap-2.5 mb-3">
      <span
        className={
          isPresent
            ? "h-6 w-6 rounded-lg bg-[var(--accent-soft)] text-[var(--accent)] flex items-center justify-center"
            : "h-6 w-6 rounded-lg bg-[#FEE2E2] text-[var(--danger)] flex items-center justify-center"
        }
      >
          ...
          <div>
            ...
            <div className="flex items-baseline gap-1.5 mt-1.5">
              <span
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(135deg, var(--accent-strong) 0%, var(--accent) 45%, var(--accent) 100%)",
