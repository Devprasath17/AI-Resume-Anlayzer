...
function PreviewCard({ children, width = 300 }) {
  return (
    <div
      className="bg-white rounded-3xl p-5 shadow-[0_30px_60px_-20px_rgba(0,0,0,0.25)]"
      style={{ width }}
    >
      {children}
    </div>
  ...
  return (
    <PreviewCard width={300}>
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[10px] font-semibold bg-[#DBEAFE] text-[#1E40AF]">
  ...
  return (
    <PreviewCard width={320}>
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[10px] font-semibold bg-[#FEE2E2] text-[#EF4444]">
          5 found
        </div>
      </div>
    ...
    <PreviewCard width={340}>
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl bg-[#DBEAFE] p-3">
          <div className="text-[9px] uppercase tracking-wide text-[#1E40AF] mb-1 font-semibold">
            Rewritten
          </div>
      ...
      <div className="space-y-2.5">
        <div className="flex flex-wrap gap-1.5">
          {present.map((k) => (
            <span
              key={k}
              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-[#DBEAFE] text-[#1E40AF]"
            >
        ...
        <div className="flex flex-wrap gap-1.5">
          {missing.map((k) => (
            <span
              key={k}
              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-[#FEE2E2] text-[#EF4444]"
            >
      ...
      <div className="space-y-2.5">
        {strengths.map((s, i) => (
          <div key={i} className="flex items-start gap-3">
            <div className="h-8 w-8 rounded-xl bg-[#DBEAFE] flex items-center justify-center text-[#1E40AF] shrink-0">
              <Sparkles size={13} />
            </div>
            <div className="flex-1 min-w-0">
