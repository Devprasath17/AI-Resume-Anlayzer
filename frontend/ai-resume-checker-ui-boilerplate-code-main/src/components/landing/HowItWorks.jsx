...
function DownloadVisual() {
  return (
    <div className="relative rounded-2xl bg-gradient-to-br from-[var(--surface-2)]/60 to-[var(--surface)] border border-[var(--border)] p-4">
      ...
      <div className="mt-3 pt-3 border-t border-[var(--border)] flex items-center justify-between">
              <div className="inline-flex items-center gap-1 h-5 px-2 rounded-full bg-[var(--accent-soft)] text-[var(--accent-strong)] text-[10px] font-semibold tabular-nums">
          ATS 86
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="mt-16 relative grid grid-cols-1 lg:grid-cols-3 gap-5">
        {/* Flowing dashed blue line behind the cards on desktop */}
        <svg
