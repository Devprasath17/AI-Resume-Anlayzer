...
export function FeaturesSection() {
  return (
    ...
    >
        {/* Atmospheric blue glow behind the section header */}
      <div
        aria-hidden
        className="absolute -top-20 left-1/2 -translate-x-1/2 w-[900px] h-[480px] pointer-events-none -z-10"
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(37,99,235,0.18) 0%, rgba(37,99,235,0.06) 35%, transparent 70%)",
          filter: "blur(60px)",
        }}
      />
          ...
          <>
            ...
            <br className="hidden sm:block" /> needs to{" "}
              <span
                style={{
                  backgroundImage:
                    "linear-gradient(120deg, #2563EB 0%, #1E40AF 60%, #2563EB 100%)",
              ...
              <div className="flex items-start gap-3">
                  <div
                    ...
                    style={{
                      ...
                      boxShadow:
                        "inset 0 1px 0 0 rgba(255,255,255,0.7), 0 1px 2px rgba(37,99,235,0.06)",
                  }}
                >
  ...
  return (
    <div className="rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] p-4">
      <div className="flex items-end justify-between mb-3">
        ...
        <div className="text-[10px] text-[var(--accent-strong)] bg-[var(--accent-soft)] px-2 py-0.5 rounded-full font-semibold tabular">
          +18 pts
        </div>
      </div>
    ...
    <div className="rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] p-4">
      ...
      <div className="flex flex-wrap gap-1.5">
        {missing.map((k) => (
          <span
            key={k}
            className="px-2 py-0.5 rounded-full bg-[#FEE2E2] text-[var(--danger)] text-[10px] font-semibold"
          >
            + {k}
          </span>
        ))}
...
function DiffPreview() {
  return (
    <div className="rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] p-3 space-y-1 font-mono text-[11px]">
      <div className="flex gap-2 px-2 py-1 rounded-md bg-[#FEE2E2]/50">
