  ...
  return (
    <div className="relative w-full h-[460px] sm:h-[520px]">
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(155deg, rgba(30,41,59,0.95) 0%, rgba(22,24,29,0.95) 50%, rgba(15,17,21,0.95) 100%)",
          boxShadow:
      ...
      >
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[rgba(96,165,250,0.14)] text-[#60A5FA] text-[10px] font-semibold">
        ...
        <div className="mt-3 flex items-center justify-center">
          <div className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-[rgba(96,165,250,0.16)] text-[#60A5FA] text-[10px] font-semibold tabular">
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="h-6 w-6 rounded-lg bg-[rgba(248,113,113,0.16)] text-[#F87171] flex items-center justify-center">
            <AlertCircle size={12} />
          </div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="h-6 w-6 rounded-lg bg-[rgba(96,165,250,0.16)] text-[#60A5FA] flex items-center justify-center">
            <Sparkles size={12} />
          </div>
          <div className="text-[11px] font-semibold text-white">AI rewrite</div>
          <div className="ml-auto inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-[rgba(96,165,250,0.16)] text-[#60A5FA] text-[9px] font-semibold">
        ...
        <div className="flex items-center gap-1.5 my-2 text-white/30">
          <ArrowRight size={11} />
          <span className="text-[9px] uppercase tracking-wide text-[#60A5FA] font-semibold">
            After
          </span>
        </div>
