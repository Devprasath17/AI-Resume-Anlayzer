          ...
          <div className="text-white">
            ...
            >
              ...
              <span
                style={{
                  backgroundImage:
                    "linear-gradient(120deg, #60A5FA 0%, #3B82F6 55%, #2563EB 100%)",
            ...
            >
              <Link
                to="/register"
                className="group relative inline-flex items-center gap-2 h-12 px-5 rounded-full font-semibold text-[14px] text-white shadow-[0_10px_30px_-8px_rgba(37,99,235,0.5)] transition-all hover:shadow-[0_14px_36px_-8px_rgba(37,99,235,0.7)] active:scale-[0.98]"
                style={{
                  background:
