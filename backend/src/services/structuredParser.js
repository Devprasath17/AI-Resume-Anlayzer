...
function buildPrompt(rawText) {
  return [
    ...
    "- basics: name, professional title, location, email, phone, social links (LinkedIn/GitHub/portfolio etc.; include a label like 'LinkedIn' and the full URL).",
    ...
    "- experience: jobs ordered most recent first, with company, role, period (preserve original date format), location if available, and bullet points.",
    ...
    "- Be conservative: omit fields that are not clearly present. Use empty strings or empty arrays where information is missing.",
